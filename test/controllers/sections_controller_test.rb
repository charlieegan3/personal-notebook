...
class SectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create section" do
    assert_difference('Section.count') do
      post sections_url, params: { section: { parent_id: @section.parent_id, user_id: @section.user_id } }
    end
  ...
  test "should update section" do
    patch section_url(@section), params: { section: { parent_id: @section.parent_id, user_id: @section.user_id } }
